	...
	<body class="BuscarAL">
		...
		<div class="container">
			...
			<form name="aluno" action="" method="POST">
				...
				<input type="submit" name="inserir" class="btn btn-danger" value="INSERIR">
				<input type="reset" name="limpar" class="btn btn-danger" value="LIMPAR"><hr>
			</form>
		</div>
